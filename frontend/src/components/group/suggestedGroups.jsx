...
function SuggGroupCard({ Group, onSendJoinRequest }) {
  ...
  return (isJoinable ?
    <div className="groupCard">
      <Image width={200} height={100} src={Group.covername || "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTLlfA6Mh7quJkQ8QarreKuct5BEuFs45u8gQ&s"} alt={Group.title} />
    ...
    <Link href={`groups/${Group.Id}`} className="groupCard">
      <Image width={200} height={100} src={`/uploads/groups_cover/${Group.covername}` || "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTLlfA6Mh7quJkQ8QarreKuct5BEuFs45u8gQ&s"} alt={Group.title} />
      <div className="groupCardContent">
        <p>{Group.title}</p>
        <p>{Group.description}</p>
