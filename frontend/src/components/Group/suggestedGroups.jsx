...
import CreateGroup from "@/app/groups/GroupCard.jsx"
import CreateGroupCard from "@/app/groups/CreateGroup"
...
function GroupCardInfo({ MembersCount, PostCount, CreatedAt }) {
  return (
    <div className="InfoCountainer">
      <Section
        Title={<MdOutlineGroups className="iconWrapper" />}
        Content={MembersCount}
        Name="Members"
      />
      <Section
        Title={<MdOutlineInsertComment className="iconWrapper" />}
        Name="Posts"
        Content={PostCount}
      />
      <Section
        Name="Events"
        Title={<MdEvent className="iconWrapper" />}
        Content={CreatedAt}
      />
    </div>
  )
